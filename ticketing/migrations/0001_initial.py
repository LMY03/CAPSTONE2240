    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('FOR REVISION', 'For Revision'), ('PROCESSING', 'Processing'), ('ONGOING', 'Ongoing'), ('COMPLETED', 'Completed'), ('ACCEPTED', 'Accepted'), ('DELETED', 'Deleted'), ('REJECTED', 'Rejected')], default='PENDING', max_length=20)),
